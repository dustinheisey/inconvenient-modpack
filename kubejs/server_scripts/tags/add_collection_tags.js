onEvent('tags.items', event => {
  ...
  addCollection('spawn_eggs', {
    ...
    chapter_5_1: {
      birthing: [
        'energeticsheep:energetic_sheep_spawn_egg',
    ...
    chapter_7_1: {
      ...
      oceans: [
        'ppr:dodo_bird_spawn_egg',
        'ppr:hawaiian_monk_seal_spawn_egg',
        ...
        'za:bass_spawn_egg',
        'za:copepod_spawn_egg',
        'za:crab_spawn_egg',
        'za:lionfish_spawn_egg',
        'za:manatee_spawn_egg',
        'za:manta_ray_spawn_egg',
        'za:octopus_spawn_egg',
        'za:seal_spawn_egg',
        'za:shark_spawn_egg',
        'za:shrimp_spawn_egg',
      ],
      wetlands: [
        'za:capybara_spawn_egg',
        'za:flamingo_spawn_egg',
        'za:leech_spawn_egg',
      ...
      jungles: [
        'ppr:bengal_tiger_spawn_egg',
        'ppr:blue_macaw_spawn_egg',
        'ppr:sumatran_orangutan_spawn_egg',
        'ecofriendly:clouded_leopard_ym_spawn_egg',
        'naturalist:coral_snake_spawn_egg',
        'za:golden_lion_tamarin_spawn_egg',
        'za:jaguar_spawn_egg',
        'crittersandcompanions:leaf_insect_spawn_egg',
      ],
      forests: [
        'ppr:moa_spawn_egg',
        'ppr:tasmanian_devil_spawn_egg',
      ...
      grasslands: [
        ...
        'za:rattlesnake_spawn_egg',
        'totemic:buffalo_spawn_egg',
        'naturalist:butterfly_spawn_egg',
        'naturalist:caterpillar_spawn_egg',
      ],
      deserts: [
        'ppr:bactrian_camel_spawn_egg',
        'naturalist:snake_spawn_egg',
        'naturalist:vulture_spawn_egg',
        'naturalist:zebra_spawn_egg',
        'za:chameleon_spawn_egg',
        'za:cobra_spawn_egg',
        'za:fennec_fox_spawn_egg',
        'za:frilled_lizard_spawn_egg',
        'za:scorpion_spawn_egg',
        'za:vulture_spawn_egg',
        'cnb:cactem_spawn_egg',
        'cnb:lizard_spawn_egg',
      ],
      colds: [
        'ppr:mountain_gorilla_spawn_egg',
        'crittersandcompanions:red_panda_spawn_egg',
        'za:penguin_spawn_egg',
        'za:steppe_eagle_spawn_egg',
        'ppr:iberian_lynx_spawn_egg',
